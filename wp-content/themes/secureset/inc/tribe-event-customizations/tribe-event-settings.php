...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	...
	// Enqueue the gform_masked_input script to use in the RSVP forms
	function tribe_rsvp_enqueue_masked_input() {
		if ( tribe_is_event() && is_single() ) {
			wp_enqueue_script( 'gform_masked_input' );	
		}
	}
	add_action( 'wp_enqueue_scripts', 'tribe_rsvp_enqueue_masked_input', 100 );
